...
<table align="center">
  <tr>
    <td valign="top" width="33%">
      <h4 align="center">🧠 Backend (.NET)</h4>
      <ul>
        <li>ASP.NET Core • .NET 8</li>
        <li>Entity Framework Core (Migrations, LINQ)</li>
        <li>RESTful API Design • Swagger</li>
        <li>AutoMapper • FluentValidation</li>
        <li>Authentication & Authorization (JWT)</li>
        <li>Clean Architecture • Layered Architecture</li>
      </ul>
    </td>
    <td valign="top" width="33%">
      <h4 align="center">💾 Databases & Ops</h4>
      <ul>
    ...
    <td valign="top" width="33%">
      <h4 align="center">🎨 Frontend & Extras</h4>
      <ul>
        <li>React • TypeScript • JavaScript</li>
        <li>HTML5 • CSS3</li>
        <li>Linux/WSL • Git & GitHub Flow</li>
        <li>Testing (Jest / Pytest – basic)</li>
        <li>AI Integrations (OpenAI • LangChain – beginner)</li>
      </ul>
    </td>
  </tr>
</table>
